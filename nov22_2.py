...
class KalmanFilterGUI(QWidget):
    ...
    def initUI(self):
        ...
        self.subplot_type_combo.currentTextChanged.connect(self.show_subplots)
        ...
        # Add plot controls to the plot layout
        ...
        right_layout.addWidget(self.track_selection_group)
    ...
    def process_data(self):
        ...
        self.tracks = self.dummy_process(input_file, track_mode, filter_option, association_type)
    ...
    def dummy_process(self, input_file, track_mode, filter_option, association_type):
        # Dummy function to simulate track processing
        # Replace this with your actual processing logic
        return [{'track_id': i, 'measurements': [(np.random.rand(3), 'Poss1') for _ in range(10)]} for i in range(5)]
    ...
    def show_subplots(self):
        ...
        subplot_type = self.subplot_type_combo.currentText()

        if subplot_type == "2 Subplots":
            # Create subplots for measurement_x and measurement_y vs time
            ...
            sync_zoom(plot_x, [plot_y])
            sync_zoom(plot_y, [plot_x])

        elif subplot_type == "3 Subplots":
